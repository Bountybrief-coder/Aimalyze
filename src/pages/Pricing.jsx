...
export default function Pricing() {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-neon-cyan via-neon-purple to-neon-pink bg-clip-text text-transparent drop-shadow-lg">
      ...
      <motion.div 
        ...
        className="relative z-10 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-20 px-4 sm:px-0"
      >
        {plans.map((plan, index) => (
          ...
          >
            ...
            >
              ...
              {/* Plan Header */}
              <div className="mb-8">
                <h2 className={`text-2xl sm:text-3xl font-bold mb-2 bg-gradient-to-r ${plan.gradient} bg-clip-text text-transparent`}>
                  {plan.name}
                </h2>
              ...
              <button
                ...
                className={`w-full py-3 px-4 rounded-lg font-bold text-sm sm:text-base mb-8 transition-all duration-300 ${
                  plan.highlighted
      ...
      >
        <h2 className="text-3xl sm:text-4xl font-bold text-center mb-4 bg-gradient-to-r from-neon-cyan via-neon-purple to-neon-pink bg-clip-text text-transparent">
        ...
        >
          {[
            ...
            >
            <h3 className="text-base sm:text-lg font-bold mb-3 text-neon-cyan group-hover:text-neon-pink transition-colors">{item.q}</h3>
              <p className="text-gray-300 leading-relaxed text-xs sm:text-sm">{item.a}</p>
            </motion.div>
          ))}
        </motion.div>
      </motion.div>
      ...
      >
        <div className="relative overflow-hidden rounded-2xl p-12 md:p-16">
          ...
          <div className="relative z-10 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 bg-gradient-to-r from-neon-cyan to-neon-pink bg-clip-text text-transparent">
            ...
            >
              <SignedIn>
                <motion.button 
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => navigate('/upload')}
                  className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-neon-cyan to-neon-pink hover:shadow-lg hover:shadow-cyan-500/50 text-gray-950 font-bold rounded-lg transition-all duration-300 text-sm sm:text-base"
                >
                  Get Started Now →
                </motion.button>
              </SignedIn>
